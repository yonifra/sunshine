...
public class Utility {
    ...
    public static String getPreferredLocation(Context context) {
        ...
        if (prefs.getBoolean(context.getString(R.string.pref_enable_gps_location), context.getString(R.string.pref_enable_gps_default) == "true")
                && MainActivity.CURRENT_GPS_CITY_NAME != null
                && prefs.getBoolean("KEY_UPDATES_ON", true))
        {

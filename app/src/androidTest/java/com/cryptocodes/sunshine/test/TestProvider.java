...
import com.cryptocodes.sunshine.data.WeatherContract.LocationEntry;
import com.cryptocodes.sunshine.data.WeatherContract.WeatherEntry;

/**
 * Created by jonathanf on 23/7/2014.
 * This class runs all tests in it (methods that start with the word "test")
 */
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.cryptocodes.sunshine/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.cryptocodes.sunshine/weather
        assertEquals(WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.cryptocodes.sunshine/weather/94074
        ...
        // content://com.cryptocodes.sunshine/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.cryptocodes.sunshine/weather
        assertEquals(WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.cryptocodes.sunshine/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.cryptocodes.sunshine/location
        assertEquals(LocationEntry.CONTENT_TYPE, type);

        // content://com.cryptocodes.sunshine/location/1
        type = mContext.getContentResolver().getType(LocationEntry.buildLocationUri(1L));
        // vnd.android.cursor.item/com.cryptocodes.sunshine/location
